...
rmse2 <- sqrt(mse2)
model3 <- randomForest(Outcome ~ Pregnancies+Glucose+BloodPressure+SkinThickness+Insulin+BMI+DiabetesPedigreeFunction+Age, data=diabetes_train, importance=TRUE, ntree=2000)
varImpPlot(model3)
